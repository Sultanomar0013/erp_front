...
function HrRequest() {
    ...
    const fakeData = Array.from({ length: 15 }, (_, index) => ({
        id: index + 1,
        requestType: `Request Name 1${index + 1}`,
        requestDetails: `Request details_${index + 1}`,
    }));
    ...
    return (
        <Box style={{ width: "100%" }}>
            ...
            <Box style={{ width: "100%", flexDirection: "column", display: "flex", justifyContent: "center", alignItems: "center" }}>
                ...
                <Typography variant="h6" >Hr Request List</Typography>

                <Box style={{ display: '', justifyItems: '' }}>
                    <Button variant="contained" onClick={handleOpen} >Add Request Type</Button>
                                ...
                                <Grid container>
                                    <Grid item xs={12} sx={{ p: '10px' }}>
                                        <TextField
                                            ...
                                            onChange={(e) =>
                                                setSelectedRow
                                                    ? setSelectedRow({ ...selectedRow, requestType: e.target.value })
                                                    : null
                                            }
                                            aria-readonly
                                        />
                                    ...
                                    <Grid item xs={12} sx={{ p: '10px' }}>
                                        <TextField
                                            ...
                                            name="requestDetails"
                                            value={selectedRow?.requestDetails || ''}
                                            onChange={(e) =>
                                                setSelectedRow
                                                    ? setSelectedRow({ ...selectedRow, requestDetails: e.target.value })
                                                    : null
                                            }
                                            multiline
                                            rows={4}

...
function ItRequestStatus() {

    const fakeData = Array.from({ length: 15 }, (_, index) => ({
        id: index + 1,
        supportName: `Support Type 1${index + 1}`,
    ...
    return (
        <Box style={{ width: "100%" }}>
            ...
            <Box style={{ width: "100%", flexDirection: "column", display: "flex", justifyContent: "center", alignItems: "center" }}>
                ...
                <Typography variant="h6" >It Support List</Typography>
                        ...
                        <Box sx={style}>
                            <form onSubmit={selectedRow === null ? handleSubmit : updateModelSubmit}>
                                <Typography
                                    ...
                                    sx={{ paddingLeft: '10px' }}
                                >
                                    {selectedRow === null ? 'Add Support' : 'View Support'}
                                </Typography>
                                <Grid container>
                                    <Grid item xs={12} sx={{ p: '10px' }}>
                                        <TextField
                                            ...
                                            label="Support Type"
                                            name="supportName"
                                            value={selectedRow?.supportName || ''}
                                            // onChange={(e) =>
                                            //     setSelectedRow
                                            //         ? setSelectedRow({ ...selectedRow, supportName: e.target.value })
                                            //         : null
                                            // }
                                            readonly
                                        />
...
export default ItRequestStatus;
